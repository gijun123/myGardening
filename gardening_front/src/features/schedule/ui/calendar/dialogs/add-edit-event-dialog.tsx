...
import {Form, FormControl, FormField, FormItem, FormLabel, FormMessage,} from "@/shared/shadcn/components/ui/form.tsx";
...
import {eventSchema, type TEventFormData,} from "@/entities/schedule/calendar/schemas.ts";
...
export function AddEditEventDialog({
    ...
    const onSubmit = (values: TEventFormData) => {
        ...
        if (values.endDate < values.startDate) {
            ...
            return; // 종료 날짜가 이전이면 이벤트 추가/수정 막기
        }
